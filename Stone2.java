/**
    Stone2 class that implements DrawingObject interphase. Stone1 uses instances of the Square class to create the shape, 
...
public class Stone2 implements DrawingObject{
    ...
    public Stone2(double x, double y) { //Constructor that gets the wanted position for the Stone2
        this.x = x;
        this.y = y;
    }
    @Override
