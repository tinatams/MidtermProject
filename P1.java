...
public class P1 extends JComponent{
    ...
    Square l_left_arm= new Square(613.4,313.48,40.14,20.61);
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.rotate(Math.toRadians(26),(613.4+40.14/2),(313.48+20.61/2));
        l_left_arm.draw(g2d);
        ...
        g2d.setTransform(originalTransform);
        g2d.rotate(Math.toRadians(41),609.85+40/2,302.33+20/2);
        right_arm.draw(g2d);
